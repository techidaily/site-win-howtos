...
##  3\. View for New Sheets
 ...
 Select "General" and go to the When Creating New Workbooks section. Select the Default View for New Sheets drop-down box and choose the view you want. Along with the two mentioned options, you can pick "Normal View." Click "OK" to save your change.
...
##  4\. Workbook to Open
 ...
 There are two different ways to make this happen. One involves changing Excel's built-in XLSTART folder, and you can find full details on this option in our how-to for [opening certain workbooks automatically](https://youtube-tips.techidaily.com/-vid-overview-top-tips-and-facts-now/).

Related: [How to Open Certain Workbooks Automatically When You Start Excel](https://youtube-tips.techidaily.com/-vid-overview-top-tips-and-facts-now/) 

 Another simpler option is to open the workbooks contained in a folder you specify. Select "Advanced" and go to the General section. Next to At Startup, Open All Files In, enter the path for the folder where you've saved the workbook you want (you may want to [copy the path using File Explorer](https://fox-links.techidaily.com/updated-2024-approved-unparalleled-screenplay-craftsmanship-across-varied-fields/)). Click "OK" to save your change.
...
##  5\. Number of Recent Workbooks
 ...
 Select "Advanced" and go to the Display section. At the top of the section, next to Show This Number of Recent Workbooks, enter a number or use the arrows to move up and down. Click "OK" to save your change.
