---
title: Laptop Keypad Not Working in Windows 11/8/7 [SOLVED]
date: 2024-08-19T06:58:13.608Z
updated: 2024-08-20T06:58:13.608Z
tags:
  - win11
  - win10
  - win7
categories:
  - CommonErrors
description: This Article Describes Laptop Keypad Not Working in Windows 11/8/7 [SOLVED]
excerpt: This Article Describes Laptop Keypad Not Working in Windows 11/8/7 [SOLVED]
...
## To fix ASUS Laptop Sound Not Working

 Here’re 5 fixes that have helped other users resolve the**ASUS laptop sound not working in Windows 10, 8.1 and 7** issue. Just work your way down the list until the problem is resolved.

1. [**Troubleshoot hardware issues**](#F1)
2. [**Make sure the volume is audible**](#F2)
3. [**Set default audio device**](#F3)
4. [**Disable audio enhancements**](#F4)
5. [**Update your audio driver**](#F5)
...
2. Try connecting your speaker or headphone device to a different port and see if this fixes the problem.
 ...
 If the no sound on the ASUS laptop problem still persists, then move on to**Fix 2** , below.
...
1. Click **the sound icon**  ![](https://images.drivereasy.com/wp-content/uploads/2018/05/img_5b0b6b255519f.png)  on the lower-right of your screen, then move **the volume slider**  all the way  to at least halfway up.  
<!-- affiliate ads begin -->
...
3. In the**Playback** tab, click on**the audio device you wish to play** , then click**Set Default** . Click**OK** .  
...
4. Check to see if your ASUS no sound problem has been fixed. If yes, then great! But if it’s still no joy, please move on to**Fix 4,** below.
...
<!-- affiliate ads end -->
![](https://images.drivereasy.com/wp-content/uploads/2021/03/2-2.jpg)
3. In the**Playback** tab, right-click on**your default audio device** and click**Properties** .  
<!-- affiliate ads begin -->
...
4. Click the**Enhancements** tab, then tick**the bo** x for**Disable all enhancements** and click**OK** .  
<!-- affiliate ads begin -->
...
5. For some sound cards, the options may differ. So you can try to see if there’s an **Advanced** tab, where you can untick the box for **Enable audio enhancements** .  
![](https://www.drivereasy.com/wp-content/uploads/2021/04/sound-enhancement.png)
6. Test your audio device and see if the no sound issue is resolved. If yes, then congrats! But if the issue remains, you should try**Fix 5** , below.
...
<!-- affiliate ads end -->
![](https://www.drivereasy.com/wp-content/uploads/2018/10/Cirrus-Logic-Superior-High-Definition-Audio.png)
...
---
 ...
 Hopefully you have successfully resolved the ASUS laptop no sound issue by now. If you have any questions, ideas or suggestions, please let me know in the comments. Thanks for reading!
