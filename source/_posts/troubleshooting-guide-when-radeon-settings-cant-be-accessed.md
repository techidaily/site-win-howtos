---
title: "Troubleshooting Guide: When Radeon Settings Can't Be Accessed"
date: 2024-09-11T15:39:16.991Z
updated: 2024-09-12T15:39:16.991Z
tags:
  - win11
  - win10
  - win7
categories:
  - CommonErrors
description: "This Article Describes Troubleshooting Guide: When Radeon Settings Can't Be Accessed"
excerpt: "This Article Describes Troubleshooting Guide: When Radeon Settings Can't Be Accessed"
...
1. [**Check for Windows Firewall**](#m1)
2. [**Disable antivirus software temporarily**](#m2)
3. [**Update the network drivers**](#m3)
4. [**Ensure every computer is connected to the same network**](#m4)
5. [**Ensure everyone is running the same version of Minecraft**](#m5)
6. [**Ensure everyone has a single IP address**](#m6)
7. [**Try a direct connect**](#m7)
8. [**Try to play Minecraft without Mods**](#m8)
9. [**Disable AP Isolation (for WiFi only)**](#m9)
10. [**Try reinstalling Minecraft**](#m10)
...
## 3\. Update the network drivers
 ...
 Outdated network drivers can also cause the LAN not to work. So you can try to update the network driver to fix the problem.
...
[ \[Free & Paid\] VPN for the USA | No Logs](https://tools.techidaily.com/drivereasy/download/)

* [Minecraft](/tag-search/?tagId=13151)
